...
CURRENT STEP: 1020a DONE. **CC zones KILL for ALL click games.** FT09=unordered set, VC33=ordered sequence. Both need exact 2px coords — no coarser representation works. LS20 ablation (1021) running. Sequence: ablation → RHAE API scoring → debate.
