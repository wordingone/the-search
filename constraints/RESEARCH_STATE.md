...
CURRENT STEP: **Step 1092: NEW PROSECUTION FAMILY HAS SIGNAL.** Forward model action selection (v23): 30% L1, ARC=0.0099/game. Predict which action causes most change in alpha space → argmax. No buffer, no attention. Prosecution now has 2 families with signal (v20 attention, v23 forward). Defense v21 still leads (ARC=0.2973 vs 0.0020 total). PB30 strengthened: simplest forward model > complex attention variants. 1092+ experiments.
  ...
  **Step 1092 SIGNAL (prosecution v23, seed 47291):** GAME_2=0%, GAME_3=0%, GAME_4=30%/SOLVED=30%/max_lvl=1/ARC=0.0099. Chain 3/5. ARC total=0.0020. **NEW FAMILY: forward model action selection.** W_fwd (256×263) predicts next enc per action in alpha-weighted space → argmax predicted change. No buffer, no attention. 3/10 seeds solve — fewer than v20 (9/10) but higher per-game efficiency (0.0099 vs 0.0037). Prosecution now has 2 families with signal.
