...
CURRENT STEP: **DEBATE v3 EXPERIMENT RACE (Step 1023b).** Mode map discovery generalizes: VC33 L1 5/5 + FT09 L1 5/5, no graph, no bans. RHAE: VC33=0.0006, FT09≈0.0014. Separability confirmed. 3.2px cluster offset (D2 says 2px needed — L1 tolerates, L2+ won't). Next: L2+ extension, LS20.
