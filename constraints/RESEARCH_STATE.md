...
CURRENT STEP: 1020 DONE. **VC33 zones KILL + ORDER-DEPENDENT (L4-L7 strictly sequential).** FT09=unordered set, VC33=ordered sequence. Both need exact coords. LS20 ablation (1021) running. Sequence: ablation → RHAE API scoring → debate.
