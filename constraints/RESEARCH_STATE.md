...
CURRENT STEP: **Steps 1104-1144: 44 experiments. 0% wall = STRUCTURAL.** v30 ONLY draw-robust result (ARC=0.33). Raw 4096D pixels detect ZERO change on 0% games — encoding resolution ruled out. Pixel scan (4096 positions), Sobel edges, temporal diff, raw pixels — ALL same wall. 0% games produce NO detectable pixel change in response to ANY action. Remaining hypothesis: multi-step action sequences required. 1144+ experiments.
