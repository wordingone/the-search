...
CURRENT STEP: 1019b PASS. **FT09 click order IRRELEVANT — all shuffles pass. FT09 minimum = unordered set of exact pixel coords (2px), no redundancy.** Next: 1020a (VC33 zone ablation, spec sent). Sequence: ablation → RHAE API scoring → debate.
