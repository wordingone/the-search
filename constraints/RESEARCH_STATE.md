...
Step 938e - Full 916 delta (ext_enc incl h) + beta * |R@h| perturbation. SPEC'D. Tests pure additive hypothesis: does h-perturbation add position-dependent signal on top of 916's trajectory-conditioned delta?
