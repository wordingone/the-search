...
**ARCHITECTURE ASSESSMENT (Steps 933-937):** 800b with alpha-weighted ext_enc change (916 formula) is IRREDUCIBLE. Every modification tested degrades LS20: encoding expansion (933: dilution), predicted novelty (934: scale), epistemic confidence (934b: equalization), h-delta (935: compression), input-distance (936: same position), adaptive lambda (937: signal loss). The 916 architecture is a local minimum. Moving away from it requires a genuinely different substrate family, not another 800b variant.
