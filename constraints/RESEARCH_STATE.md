...
Step 938c - Trajectory-conditioned action perturbation (h-projection). SPEC'D. delta on raw enc + beta * R@h. h is position-dependent, global, gate-5-clean. Tests whether h provides useful action signal.
