...
Step 937 QUEUED - Adaptive EMA decay (chemotaxis-inspired, Prop 25). Lambda adapts to observation change variance. Formula corrected (was inverted in original spec).
