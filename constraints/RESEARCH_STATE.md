...
PIVOT (2026-03-23): Critical path = prediction accuracy R3_cf (bug-fixed). Does warm W predict better than cold W on test seeds? FT09 pivot for L1-based testing (diversity helps on click games). LS20 L1 uninformative for post-ban mechanisms.
