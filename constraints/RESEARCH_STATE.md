...
**Step 1275 (novelty-gated tube flow):** COMPLETE (100 runs, 21.1 min). KILL — novelty gate had zero effect on I3 regression. ls20 PHY I3ρ=-0.486 (vs -0.47 mean in 1274 — identical). cn04 PHY I3ρ=-0.679 (same as 1274). FT09 PHY L1=3/5 (vs 4/5 in 1274, within variance). Chain ARC=0.00000090 (vs 0.00000096 in 1274, slight drop). Root cause: the I3 regression is not caused by reinforcing REPETITIVE deltas — it's caused by reinforcing RESPONSIVE actions period. Responsive actions produce the MOST novel deltas (novel because they actually advance game state), so novelty gating still reinforces them. The tube dynamics fundamentally over-weight the responsive actions regardless of novelty gate.
