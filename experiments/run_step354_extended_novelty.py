#!/usr/bin/env python3
"""
Step 354 -- ARC-AGI-3: extended pure novelty, 200000 steps.

Same as Step 353 but 200000 steps. Measure how many levels pure novelty clears.
Script: scripts/run_step354_extended_novelty.py
"""
...
def main():
    t0 = time.time()
    print("Step 354 -- ARC-AGI-3: pure novelty, persistent codebook, 200000 steps", flush=True)
    ...
    print(f"max_steps=200000  k=3", flush=True)
    print(flush=True)

    r = run_game(arc, ls20.game_id,
                 max_steps=200000, max_resets=2000,
                 k=3, verbose=True)
    ...
    print(flush=True)
    print("=" * 60, flush=True)
    print("STEP 354 SUMMARY", flush=True)
    print("=" * 60, flush=True)
