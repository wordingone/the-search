"""
sub1062_defense_v13.py — Defense v13: multi-timescale adaptive cascade (ℓ₁).

SUBSTRATE-ONLY FILE. No main(), no harness, no run loop.
Run via: python run_experiment.py --step 1062 --substrate experiments/sub1062_defense_v13.py

FAMILY: parametric-goal
R3 HYPOTHESIS: ℓ₁ adaptive cascade with multi-timescale change detection.
  Same multi-timescale probes as prosecution v12 (short/medium/long change +
  distribution drift). SPSA goal adapts across timescales.
...
CONFIG = {
    ...
    "spsa_lr": SPSA_LR,
    "v13_features": "multi-timescale cascade — short/medium/long change + drift detection + SPSA (l_1)",
}

SUBSTRATE_CLASS = DefenseV13Substrate
