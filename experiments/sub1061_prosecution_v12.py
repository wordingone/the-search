"""
sub1061_prosecution_v12.py — Prosecution v12: multi-timescale adaptive cascade (ℓ_π).

SUBSTRATE-ONLY FILE. No main(), no harness, no run loop.
Run via: python run_experiment.py --step 1061 --substrate experiments/sub1061_prosecution_v12.py

FAMILY: attention-gated
R3 HYPOTHESIS: ℓ_π adaptive cascade with multi-timescale change detection.
  0% games may have DELAYED feedback — action at t, visible effect at t+5
  or t+50. Per-step change detection misses this. Track change at 3 timescales:
  short (t+1), medium (t+5), long (t+50). Also detect distribution drift.

  Attention adapts to which timescale is informative per dimension (ℓ_π R3).
...
CONFIG = {
    ...
    "att_init": ATT_INIT,
    "att_lr": ATT_LR,
    "v12_features": "multi-timescale cascade — short/medium/long change + drift detection (l_pi)",
}

SUBSTRATE_CLASS = ProsecutionV12Substrate
