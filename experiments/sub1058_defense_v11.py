"""
sub1058_defense_v11.py — Defense v11: adaptive cascading strategy (ℓ₁).

SUBSTRATE-ONLY FILE. No main(), no harness, no run loop.
Run via: python run_experiment.py --step 1058 --substrate experiments/sub1058_defense_v11.py

FAMILY: parametric-goal
R3 HYPOTHESIS: ℓ₁ with adaptive strategy allocation via short probes.
  Same cascade structure as prosecution v10. Defense counter: SPSA goal
  adapts during probes, and the goal learned in KB probe transfers to
  guide sequence construction via change_map * goal-mismatch weighting.

Step 0-500: KEYBOARD PROBE — build change_map + SPSA goal.
Step 500-1000: CLICK PROBE (if KB failed) — SPSA updates from clicks.
...
CONFIG = {
    ...
    "spsa_lr": SPSA_LR,
    "v11_features": "adaptive cascade — short probes + early exit + SPSA goal transfer (l_1)",
}

SUBSTRATE_CLASS = DefenseV11Substrate
