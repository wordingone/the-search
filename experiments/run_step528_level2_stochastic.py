...
def main():
    ...
    if n_stoch == 0:
        print("DIAGNOSTIC: zero stochastic edges. hash perfectly separates reachable set.")
        print("the 259-cell ceiling is real topology, not hash artifact.")
    elif mc > 259:
        print(f"SIGNAL: {mc} > 259. rare transitions expand reachable set.")
    else:
        print(f"NO SIGNAL: {mc} <= 259. rare transitions exist but lead back inside.")
