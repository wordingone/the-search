"""
Step 1360 — Small Mamba-style SSM with online RTRL.
Leo mail 3876, 2026-03-30. Paradigm shift from MLP+TP.
...
- Action head: W_act @ y_t (fixed random, not trained)
- RTRL: explicit per-step gradient updates for B, C, A_param, W_delta
