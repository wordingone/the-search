"""Tier 1 test for step 1398 — dolphin v3 (change-based priority).
Games: R11L (v1-zero, still growing — target), VC33 (passing control), TN36 (cycle control).
10 seeds, 5K steps.
Leo mail 4555, 2026-04-13.

Kill: K_tier1 <= 1/3.
Expected: VC33=10/10, TN36~0/10 (unchanged), R11L > 0/10 if v3 helps.
"""
...
out_path = 'B:/M/the-search/chain_results/runs/tier1_1398_dolphin_v3.json'
