...
RESULTS_DIR = os.path.join('B:/M/the-search/experiments/compositions', 'results_1273')
...
def main():
    ...
    print(f"\n{'='*70}")
    print(f"STEP 1273 COMPLETE — {len(all_results)} runs in {total_elapsed:.1f}s")
    print(f"{'='*70}\n")
