...
STEP        = 1389
N_DRAWS     = 50
DRAW_SEEDS  = [14280 + i for i in range(N_DRAWS)]
TRY1_STEPS  = 2000
TRY2_STEPS  = 2000
TRY2_SEED   = 0   # same as try1 — matching layouts
MAX_SECONDS = 280
...
CONDITIONS    = ['INTERVENTION-SAME', 'RANDOM-SAME']
...
def run_draw(draw_idx, draw_seed, cond_name, max_steps):
    ...
    try2_progress   = {}
    optimal_steps_d = {}
    mode = 'intervention' if 'intervention' in cond_name.lower() else 'random'
...
def main():
    ...
    int_rhae = rhae_by_cond['INTERVENTION-SAME']
    rnd_rhae = rhae_by_cond['RANDOM-SAME']
