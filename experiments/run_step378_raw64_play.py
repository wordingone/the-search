#!/usr/bin/env python3
"""
Step 378 -- Raw 64x64, 50K steps. Does it find Level 1?

frame.flatten() / 15.0 -> 4096 dims. F.normalize. No encoding.
50K steps on LS20. Kill: level 1 from raw pixels.
Script: scripts/run_step378_raw64_play.py
"""
...
def main():
    t0=time.time()
    print(f"Step 378 -- Raw 64x64 on LS20. {D} dims. 50K steps. No encoding.",flush=True)
    ...
    print("STEP 378 SUMMARY",flush=True); print("="*60,flush=True)
