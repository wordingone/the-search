#!/usr/bin/env python3
"""
Step 50: Dual-representation cells (vector codebook + matrix dynamics).
...
from fluxcore_compressed_v12 import CompressedKernel, _vec_cosine
...
def main():
    ...
    print(f"\nStep 50: Dual-representation cells (v12)")
    ...
    print(f"  Step 50 (v12):     {cov}/33, energy={final_energy:.6f}")
