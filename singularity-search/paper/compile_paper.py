#!/usr/bin/env python3
"""
Paper Compiler — Generates paper/paper.html from .knowledge/ system.

ALL content is derived dynamically from:
  - .knowledge/entries/*.json (experiments, discoveries, decisions, architecture)
  - .knowledge/constraints.json (what not to do)
  - .knowledge/frozen_frame.json (frozen/adaptive element tracking)
  - .knowledge/state.md (current status)
  - CLAUDE.md (the constitution — five principles and eight stages)
