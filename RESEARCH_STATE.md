...
| **542** | **Recode on LS20 (LSH k=16 + passive refinement + argmin)** | — | **5/5 L1** | **BEST NON-CODEBOOK RESULT.** L1@16437-61680. max_cells=1267 (>440 LSH baseline). 300 refinement splits across all seeds. Pure argmin + passive refinement = no noisy TV. Seed 2 (former dud) navigates at k=16. **Self-refinement expands reachable set.** L2 still 0/5. |
