...
| **488** | **Fresh H + fresh edges per level** | — | **25%** | **L1: 3/3. L2: 0/3.** Fresh random projection still fails. Level 2 is structurally harder — not projection, not edges. 200-290K steps insufficient for Level 2 even with clean state. Level 1: solved (10/10). Level 2: different frontier, possibly much larger search space or different mechanics. Clean boundary for LSH+argmin. |
