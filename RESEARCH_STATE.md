...
| **612** | **LS20 L4 bootstrap fix (Option C)** | — | **STRUCTURALLY CORRECT** | _update_bg builds puq wall_set at game_level=2 when l3_frames >= WARMUP AND l2_count >= N_MAP_PUQ. Mirrors mgu bootstrap. Cannot verify in 5min (needs 100K+ steps). 612b running at 300s/seed. |
