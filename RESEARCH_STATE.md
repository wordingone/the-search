...
| **541** | **Absorb + stricter filter (cutoff=0.75, window=10)** | — | **0/3 L1** | **REGRESSES from 1/3 to 0/3.** Step 540's L1 was at ratio=0.74 (below 0.75 cutoff). Stricter filter blocked the navigation window. **Entropy-seeking direction KILLED** across 3 experiments (539-541). Noisy TV is the dominant failure. |
