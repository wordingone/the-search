...
| **470** | **Raw 64x64 + k=16 LSH on LS20** | — | **25%** | **1/5 at 50K.** LSH handles 4096D (navigates) but avgpool16 is genuinely better (6/10 vs 1/5). 968/65536 cells occupied. avgpool is needed signal compression, not a codebook limitation. Encoding wall confirmed: avgpool16 is LS20-specific but universally helpful for navigation quality. |
