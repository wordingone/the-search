...
| **618** | **LS20 L4 (616 argmin + 572u mgu + bootstrap)** | — | **FAIL** | L1 works (s0@13922, s1@3383). mgu COMPLETELY fails: wp=0, lhs=0 across 5000+ cycles. Agent cycles L0→L1 but never reaches a single mgu waypoint. Game geometry likely changed since 572u's original L3=5/5. The 572u coordinates (MGU_SPAWN, KDY_GRID, LHS) may be wrong for current env. **LS20 L4+ push BLOCKED until mgu waypoints are recalibrated.** |
