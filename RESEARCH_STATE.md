...
| **616** | **LS20 L4 (no L0 cluster + no G reset + bootstrap)** | — | **PARTIAL** | L0 fixed (7071 episodes/5min). L1 reached (s0@13922, s1@3383). L2=0 — MGU_SPAWN=(29,40) wrong for current game (avatar at col≈13, row≈62). Action mapping may be transposed. 572u code has correct constants. Next: port 572u mgu into 606 framework. |
