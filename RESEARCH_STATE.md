...
| **482** | **Global cell novelty (anti-revisitation penalty)** | — | **25%** | **6/10 — same count, DIFFERENT seeds.** Global pressure shifts which seeds win (1,2,3,4,8,9) vs argmin (0,2,3,4,5,7). Complementary, not redundant. Ensemble of both could reach 8-9/10. First hint of breaking the wall through mechanism COMBINATION, not replacement. |
