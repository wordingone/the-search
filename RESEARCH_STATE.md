...
| **491** | **Death-state avoidance on Level 2** | — | **25%** | **WORSE: 227 cells vs 240.** Death avoidance REDUCES exploration — deaths were opening new states. Risky paths are the only paths to many cells. Physical gap confirmed: no-decay (259), decay (241), death-avoidance (227) all fail. Level 2 reward unreachable by ANY form of random walk + edge manipulation. Multi-level direction CLOSED. I6/I9 (purposeful exploration) is the confirmed gap. |
