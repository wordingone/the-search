...
| **483** | **Ensemble (argmin + global novelty parallel)** | — | **25%** | **6/10. GAME CEILING confirmed.** Seeds 1,2,5,6 fail for BOTH mechanisms. The hard seeds are shared — 6/10 is the probability that a random initial trajectory reaches LS20's reward region within 50K steps. No mechanism can fix trajectory luck. 32 experiments (456-483) map the ceiling completely. The random walk + covering paradigm has reached its natural limit on LS20. |
