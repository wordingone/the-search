...
| **472** | **Concat encoding (pos+diff) + k=12 on LS20** | — | **25%** | **2/5 at 50K.** Higher sig_q (0.206 vs 0.184) but worse navigation — extra dims disperse LSH partitioning. U13 confirmed for encoding: additions hurt. Encoding leaderboard: centered_enc+avgpool16 (6/10) > concat=diff=tanh (2/5) > raw64 (1/5). Baseline is robust. |
