...
| **490** | **Edge decay on Level 2 (0.999-0.99999)** | — | **25%** | **0/3. Decay has ZERO effect.** All rates produce identical cell milestones (206→229→236). The trap is SPATIAL, not convergence — Level 2 has ~240 reachable states with reward in a disconnected region. Random walk can't bridge the gap. Level 2 requires purposeful exploration (I6/I9) or death-state avoidance. Multi-level closes here for argmin. |
