...
| **539** | **Absorb on LS20 (12th family)** | — | **0/3 L1** | 373 cells, 291 refinement splits. **Argmax entropy = death-seeking** (~775 deaths/100K). Confused edges cluster near death states. Entropy decreases over time (3.47→2.52). Refinement fires correctly but doesn't expand reachable set. Needs survival bias. |
