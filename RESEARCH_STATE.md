...
| **544** | **Recode uncentered on LS20** | — | **KILL 0/5** | 62 cells (vs 1267 centered). Without centering, observations cluster in positive corner — hash bits uninformative. **Centering required for navigation, kills domain separation for chain. Structural tension.** |
