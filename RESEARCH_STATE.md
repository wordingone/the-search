...
| **543** | **Recode chain (CIFAR→LS20→CIFAR)** | — | **KILL 0/3** | CIFAR floods graph with 6000+ nodes. Centering kills L2-scale domain separation — both domains hash to shared nodes. Same failure as SplitTree (Step 538). Unexpected: CIFAR accuracy 15% (15x above chance). |
