...
| **471** | **Diff-frame encoding + k=12 on LS20** | — | **25%** | **2/5 at 50K.** Diff frames non-degenerate (453 cells, occ=11%) but weaker than raw frame (6/10). sig_q=0.117 vs 0.184 baseline. Transitions have less discriminability than positions for argmin. More cells but weaker signal per cell. Not an improvement over centered_enc. |
