...
- Graph + edge-count argmin is the constant across all winning navigation configurations. No family has won without it. However, random action selection achieves 10/20 L1 at 50K vs argmin's 13/20 (Step 594, p=0.26, NS). The advantage is in SPEED of discovery, not exclusive access: argmin systematically covers the state space faster (222 cells vs ~88 for random at 10K), but at long horizons both agents accumulate enough exploration attempts.
