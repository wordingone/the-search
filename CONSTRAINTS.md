...
| U27 | Attractor-creating signals kill navigation; attractor-removing signals help | **NEW (provisional)** | Steps 477-482: 6 targeted exploration strategies tested. Prediction error (481, 0/10) and destination novelty (478, 1/10) CREATE attractors toward specific states → traps. Step 581d (4/5): soft death penalty REMOVES attractors from death edges → frees exploration. Step 582 (4/5): ops as data removes death attractors. Argmin itself is attractor-removing (biases against visited states). Mechanistic prediction: signals compatible with exploration (removing attractors) help; signals that steer exploration (creating attractors) create noisy TV traps. Evidence from ~10 experiments, LS20 only. Needs cross-game and cross-family testing. Hart debate (2026-03-21) proposed this framing as sharper than optimization/consequence distinction. |
